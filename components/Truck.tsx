    ...
    bg-cover bg-no-repeat lg:rounded-5xl 2xl:rounded-5xl`}>
      ...
      lg:py-10'>
        <div className='flexCenter gap-4'>
          <div className='rounded-full bg-green-50 p-50 p-4'>
            <Image
              src="/folded-map.svg"
              alt='map'
              width={28}
    ...
    flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
        ...
        xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl'>
          <h2 className='bold-24 md:bold-32 2xl:bold-64 capitalize text-white'>Looking for a credible and safe way to move your belongings?</h2>
          <p className='regular-14 xl:regular-16 mt-5 text-white'>
            Starting from the anxiety of looking for a reliable service to move your 
            belongings from school to your home and vice versa. The struggle of carrying your belongings
            and paying high prices for additional cost of the belongings. This is the reason why we are here, to
            relieve you of all that stress.
          </p>
          <Image
            src="/quote.svg"
            alt='camp-2'
